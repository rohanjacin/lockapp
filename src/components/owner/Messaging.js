...
function Messaging () {
	...
	async function receiveMessages () {
		...
		const callback = (message) => {
			...
			let guestMsg = String.fromCharCode(...payload);			
			console.log("payload:", guestMsg);
			setMessageList(guestMsg)
		}
	...
	return (
		<div className="Messaging">
			<h2>Chat Messages</h2>
			<br/>
			<input placeholder="Messages from Guest will appear here.."
			...
			<br/>
			<br/>
			<input placeholder="Enter message to send to Guest.."
